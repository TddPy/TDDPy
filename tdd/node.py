...
class Node:
    ...
    @staticmethod
    def CUDAcpl_Tensor(node: Node|None, weights: CUDAcpl_Tensor, data_shape: List[int]) -> CUDAcpl_Tensor:
        '''
        ...
        if node == None:
            ...
            tensor_dict = dict()
            res = node.__CUDAcpl_Tensor(weights, data_shape, tensor_dict)
    ...
    def __CUDAcpl_Tensor(self, weights: CUDAcpl_Tensor, data_shape: List[int], tensor_dict: Dict) -> CUDAcpl_Tensor:
        '''
        ...
        for k in range(self.index_range):
            ...
            if succ == None:
                ...
                if key in tensor_dict:
                    ...
                    temp_tensor = succ.__CUDAcpl_Tensor(self.out_weights[k],data_shape, tensor_dict)
                    next_order = succ.order
