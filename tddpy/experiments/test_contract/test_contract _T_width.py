...
def tddpy_construct():
    ...
    tdd1 = tddpy.TDD.as_tensor(((gates_1[0],0,[]),None))
    tdd2 = tddpy.TDD.as_tensor(((gates_2[0],0,[]),None))
...
def tddpy_construct_T():
    ...
    for i in range(width):
        index_order.append(i)
        index_order.append(i+width)
    tdd1 = tddpy.TDD.as_tensor(((gates_1,1,[]),None))
    tdd2 = tddpy.TDD.as_tensor(((gates_2,1,[]),None))
...
if __name__ == "__main__":
    ...
    with open("D:/r_d{}_c{}.csv".format(depth, count), "a") as pfile:
        pfile.write("count, width, size_tdd1, size_tdd2, time_tddpy_construct, time_tddpy_contract, time_tddpy_construct_T, time_tddpy_contract_T, size_res_tddpy\n")
        while (True):
            for width in range(4, width_max+1):
                ...
                pfile.write("{}, {}, {}, {}, {}, {}, {}, {}, {}\n"
                            .format(count, width, size_tdd_1, size_tdd_2, time_tddpy_construct,
