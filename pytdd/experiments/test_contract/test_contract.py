...
def pytdd_construct():
    ...
    tdd1 = pytdd.TDD.as_tensor(((gates_1,0,[]),None))
    tdd2 = pytdd.TDD.as_tensor(((gates_2,0,[]),None))
...
def pytdd_contract():
    ...
    for i in range(width):
        indices1.append(i*2+1)
        indices2.append(i*2)
    result = pytdd.TDD.tensordot(tdd1, tdd2, [indices1, indices2])
...
if __name__ == "__main__":
    ...
    with open("D:/r_d{}.csv".format(depth), "a") as pfile:
        pfile.write("width, torch_time, size_tdd1, size_tdd2, time_ori_construct, time_ori_contract, size_res_ori, time_pytdd_construct, time_pytdd_contract, size_res_pytdd\n")
        while (True):
            for width in range(4, width_max+1):
                ...
                pfile.write("{}, {}, {}, {}, {}, {}, {}, {}, {}, {}\n"
                            .format(width, time_pytorch, size_tdd_1, size_tdd_2, time_original_construct, 
                                    time_original_total - time_original_construct, size_result_original, time_pytdd_construct,
                                    time_pytdd_contract, size_result_pytdd))
                pfile.flush()
